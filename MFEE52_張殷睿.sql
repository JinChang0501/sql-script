...
-- <<提示一>>共7人
-- <<提示二>>同一家人會一起上下船
select pname,survived from full_passengers
...
select * from full_passengers where pname like '%Anna%' or pname like 'Mrs.%';

select * from full_passengers where pname like '%Anna%' and pname like '%Brogren%';
